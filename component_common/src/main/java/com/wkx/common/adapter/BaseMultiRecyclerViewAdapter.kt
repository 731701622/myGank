...
abstract class BaseMultiRecyclerViewAdapter<T> constructor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        when (viewType) {
            ...
            TYPE_LOAD_MORE -> {
                loadMoreViewHolder = BaseViewHolder.create(parent, R.layout.common_recycler_load_more)
                ...
                holder.itemView.setOnClickListener {
                    ...
                    onItemClickListener?.onItemClick(it, dataSourceList[position], position)
                }
                return holder
            }
        }
...
//        }
    ...
    @JvmOverloads
    fun addHeaderView(header: View, index: Int = getHeaderCount(), orientation: Int = LinearLayout.VERTICAL): Int {
